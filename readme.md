...
### Nettsidelasting
1. Se video om content optimization. (Ikke bestemt ennå)
2. Se på case fra prosjekt.

Stikkord: Chrome-dev-tools, Gzipping, minification og bundling, bildeoptimalisering, Critical rendering path, "Above the fold",

### Nettleserytelse
1. Se Paul-Irish video
2. Case fra prosjekt, gjerne en runde i timeline og andre verktøy i Chrome.
